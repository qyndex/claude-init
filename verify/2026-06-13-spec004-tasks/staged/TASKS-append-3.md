...
- [ ] T-153  | spec:004  | phase:7  | priority: high  | created: 2026-06-13  | last_touched: 2026-06-13  | deps:  | parallel: yes  | est: 10m
  ...
  accept: for f in claude-security claude daily-failure-autofix daily-stale-deps hotfix-ingest; do grep -q 'CLAUDE_CODE_OAUTH_TOKEN' ".github/workflows/$f.yml" || exit 1; done; ! grep -q 'claude-code-security-review' .github/workflows/claude-security.yml
  owner: implementer
```
